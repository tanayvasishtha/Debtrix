    ...
    return (
        <div className="min-h-screen bg-gray-900">
                ...
                {mobileMenuOpen && (
                    <div className="md:hidden bg-gray-900 border-t border-gray-800">
                        <div className="container mx-auto px-6 py-4 space-y-3">
                            ...
                            <Link href="/chat" className="block text-gray-300 hover:text-white">AI Coach</Link>
                            <Link href="/learn" className="block text-green-400 font-medium">Learn</Link>
                            <Link href="/assessment" className="block text-gray-300 hover:text-white">Assessment</Link>
                        </div>
                    </div>
                )}
            </nav>
            ...
            <div className="pt-20">
                    ...
                    <div className="container mx-auto px-6">
                        <div className="max-w-4xl mx-auto text-center">
                            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
                                Financial <span className="text-green-400">Education</span> Center
                            </h1>
                            <p className="text-xl text-gray-300 mb-8">
                                Learn proven strategies to eliminate debt, build wealth, and achieve financial freedom
                            </p>
                ...
                {/* Categories */}
                <div className="bg-gray-800/50 py-8 sticky top-20 z-40">
                    <div className="container mx-auto px-6">
                        ...
                        <div className="container mx-auto px-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                {featuredPosts.map((post) => (
                                    <Card key={post.id} className="bg-gray-800 border-gray-700 hover:border-green-500 transition-colors group">
                                        <CardHeader>
